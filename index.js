...
const grupch1 = 'by alpin'; // OFFICIAL GRUP LU 1
const grupch2 = 'https://youtube.com/channel/UCPfM-qelpkAnDwBPF00k_XQ'; // OFFICIAL YT LU
const grupch3 = 'bacot'; // OFFICIAL GRUP LU 3
//
...
conn.on('user-presence-update', json => console.log(`[ ${moment().format("HH:mm:ss")} ] => bot by @alpin_GRUP'))
conn.on('message-status-update', json =>
{
   const participant = json.participant ? ' (' + json.participant + ')' : '' // participant exists when the message is from a group
   console.log(`[ ${moment().format("HH:mm:ss")} ] => bot by @alpin_GRUP`)
})
...
conn.sendMessage(id, 'Owner alpin ofc : wa.me/+6289690719275' ,MessageType.text);
}
else if (text == 'bot'){
...
//Tolonglah bro jangan di ubah ubah alpin
